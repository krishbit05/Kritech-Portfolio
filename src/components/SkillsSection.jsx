...
const skills = [
    ...
    { name: "Postgress SQL", level:60, category: "backend" },
    { name: "Git & GitHub", level: 88, category: "tools" },
    { name: "Figma", level: 65, category: "tools" },
    { name: "Linux & CLI", level: 60, category: "tools" }
]
                    ...
                    {filterskills.map((skill,key)=>(
                        <div key={key} className="bg-card p-6 rounded-lg shadow-xs card-hover">
                            ...
                            <div className="w-full bg-primary/30 h-2 rounded-full overflow-hidden">
                                <div className="bg-primary h-2 rounded-full origin-left animate-[grow_1.5s_ease-out] transition-width" style={{width:skill.level+"%"}}/>
                            </div>
